...
class twitterwidget extends WP_Widget {
    function twitterwidget() {		
			$widget_ops = array('classname' => 'twitterwidget', 'description' => esc_html__( "Display Your Tweets.", 'betube-helper') );
			parent::__construct(false, esc_html__('BeTube Twitter', 'betube-helper'), $widget_ops);		
    }
    function form($instance){ ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e( 'Title', 'betube-helper' ); ?>:</label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('username')); ?>"><?php esc_html_e( 'User Name', 'betube-helper' ); ?>:</label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('tweetstoshow')); ?>"><?php esc_html_e( 'Tweets to display', 'betube-helper' ); ?>:</label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('cachetime')); ?>"><?php esc_html_e( 'cachetime', 'betube-helper' ); ?>:</label>
