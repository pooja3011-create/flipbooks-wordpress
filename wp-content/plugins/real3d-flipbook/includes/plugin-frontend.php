	     ...
	     if($pdfUrl != -1 || $flipbook['type'] == 'pdf'){
		     ...
		     if (!wp_script_is( 'real3d_flipbook_pdfjs', 'enqueued' )) {
		     	//wp_enqueue_script("real3d_flipbook_pdfjs", plugins_url()."/real3d-flipbook/js/pdf.min.js", array(),REAL3D_FLIPBOOK_VERSION);
                        wp_enqueue_script("real3d_flipbook_pdfjs", plugins_url()."/real3d-flipbook/js/pdf.combined.js", array(),REAL3D_FLIPBOOK_VERSION);
                        // wp_enqueue_script("real3d_flipbook_pdfjs", "https://npmcdn.com/pdfjs-dist@1.4.79/build/pdf.combined.js", array(),REAL3D_FLIPBOOK_VERSION);
		     }
